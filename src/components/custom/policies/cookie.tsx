...
export function CookieConsent() {
    ...
    return (
        ...
        <div className="pointer-events-none fixed inset-x-0 bottom-0 px-6 pb-6">
            ...
            <p className="text-sm leading-6 text-gray-900">{t('cookieConsent.text')}
            ...
            <div className="mt-4 flex items-center gap-x-5">
                <button type="button" className="rounded-md bg-gray-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900"
                    onClick={accept}>
...
export function CookieRefusedForm() {
    ...
    return (
      <div className="flex h-full flex-col items-center justify-center gap-4 rounded-xl bg-white px-8 py-4 shadow">
        ...
        <p className="text-sm leading-6 text-gray-900">{t('cookieDisabled.description')}
                <a href="/policies" className="font-semibold text-indigo-600">
                    {t('cookieConsent.privacyPolicy')}
                </a>
                .
