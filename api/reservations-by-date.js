...
async function sendReservationEmail({ hash, email, date, language }) {
  ...
  const enContent = {
    ...
    plainText: `This is the confirmation of the reservation for ${formattedDate} at ${formattedTime}`,
    html: generateEmail({
      email,
      date: formattedDate,
      time: formattedTime,
  ...
  const frContent = {
    ...
    plainText: `Ceci est la confirmation de la réservation pour ${formattedDate} à ${formattedTime}`,
    html: generateEmail({
      email,
      date: formattedDate,
      time: formattedTime,
...
function generateEmail({ email, date, time, hash, rawDate }) {
